...
loop <lb0> (iter=13) {
  ...
  epoch <rb1> {
    cell (x=0, y=0) {
      ...
      rop <load_r_2_2> (slot=1, port=0) {
        ...
        rep (slot=1, port=0, level=0, iter=255, step=13, delay=13)
      }

      rop <load_w_2_2> (slot=1, port=2) {
        dsu (slot=1, port=2, init_addr=1)
        rep (slot=1, port=2, level=0, iter=255, step=0, delay=13)
			}
      #3.2-read IOSRAM
      #round1: layer1 row0 of input matrix
      rop <read_io_3_2> (slot=2, port=3) {
        dsu (slot=2, port=3, init_addr=1)
        rep (slot=2, port=3, level=0, iter=255, step=0, delay=13)
			}
    }
    cell (x=1, y=0) {
      #remaining layers
      rop <write_rf4> (slot=4, port=2) {
        ...
        rep (slot=4, port=2, level=0, iter=255, step=0, delay=13)
			}
      ...
      rop <read_rf3> (slot=3, port=1) {
        ...
        rep (slot=3, port=1, level=1, iter=255, step=0, delay=1)
      }
      rop <read_rf4> (slot=4, port=1) {
        dsu (slot=4, port=1, init_addr=0)
			  rep (slot=4, port=1, level=0, iter=13, step=1, delay=0)
        rep (slot=4, port=1, level=1, iter=255, step=0, delay=1)
      }
      ...
      rop <write_rf3_back> (slot=3, port=0) {
        dsu (slot=3, port=0, init_addr=0)
			  rep (slot=3, port=0, level=0, iter=13, step=1, delay=0)
        rep (slot=3, port=0, level=1, iter=255, step=0, delay=1)
      }
    ...
    cell (x=2, y=0) {
      ...
      rop <output_w_3_1> (slot=1, port=1) {
        dsu (slot=1, port=1, init_addr_sd=1, init_addr=1)
			}
    }
    
    #cell (x=1, y=0) {
    #  rop <none> (slot=0, port=0) {
    #    wait (cycle=1)
    #  }
    #}
    #cell (x=2, y=0) {
  ...
  epoch <cbl1> {
    cell (x=0, y=0) {
      cop <addr_calc1> {
        calc (mode=1, operand1=2, operand2_sd=0, operand2=1, result=2)
      }
    }
  }
