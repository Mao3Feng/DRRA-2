...
loop <lb0> (iter=416) { #416
  epoch <rb0> {
    cell (x=0, y=0) {
      ...
      rop <load_r_2_2> (slot=1, port=0) {
        ...
        rep (slot=1, port=0, level=0, iter=26, step=1, delay=0)
      }
      rop <load_w_2_2> (slot=1, port=2) {
        dsu (slot=1, port=2, init_addr=1)
        rep (slot=1, port=2, level=0, iter=26, step=1, delay=0)
      }
      #3.2-read IOSRAM
      #round1: row0-1 of input matrix
      rop <read_io_3_2> (slot=2, port=3) {
        ...
        rep (slot=2, port=3, level=1, iter=6, step=4, delay=60)
      }
      rop <read_io_3_3> (slot=2, port=3) {
        dsu (slot=2, port=3, init_addr=25)
    ...
    cell (x=1, y=0) {
      rop <write_rf6_1> (slot=6, port=2) {
        ...
        rep (slot=6, port=2, level=1, iter=6, step=0, delay=60)
      }
      ...
      rop <read_rf5_1> (slot=5, port=1) {
        ...
        rep (slot=5, port=1, level=0, iter=64, step=0, delay=0)
        rep (slot=5, port=1, level=1, iter=6, step=0, delay=0)
      }
      rop <read_rf6_1> (slot=6, port=1) {
        dsu (slot=6, port=1, init_addr=0)
        rep (slot=6, port=1, level=0, iter=64, step=1, delay=0)
        rep (slot=6, port=1, level=1, iter=6, step=0, delay=0)
      }
      rop <read_rf5_2> (slot=5, port=1) {
        dsu (slot=5, port=1, init_addr=0)
        rep (slot=5, port=1, level=0, iter=32, step=0, delay=0)
      }
      rop <read_rf6_2> (slot=6, port=1) {
        dsu (slot=6, port=1, init_addr=0)
        rep (slot=6, port=1, level=0, iter=32, step=1, delay=0)
      }
      ...
      rop <read_rf7_1> (slot=7, port=1) {
        ...
        rep (slot=7, port=1, level=0, iter=64, step=0, delay=0)
        rep (slot=7, port=1, level=1, iter=6, step=0, delay=0)
      }
      rop <read_rf8_1> (slot=8, port=1) {
        dsu (slot=8, port=1, init_addr=0)
        rep (slot=8, port=1, level=0, iter=64, step=1, delay=0)
        rep (slot=8, port=1, level=1, iter=6, step=0, delay=0)
      }
      rop <read_rf7_2> (slot=7, port=1) {
        dsu (slot=7, port=1, init_addr=1)
        rep (slot=7, port=1, level=0, iter=32, step=0, delay=0)
      }
      rop <read_rf8_2> (slot=8, port=1) {
        dsu (slot=8, port=1, init_addr=0)
        rep (slot=8, port=1, level=0, iter=32, step=1, delay=0)
      }
      ...
      rop <write_rf8_1> (slot=8, port=0) {
        ...
        rep (slot=8, port=0, level=0, iter=64, step=1, delay=0)
        rep (slot=8, port=0, level=1, iter=6, step=0, delay=0)
      }
      rop <write_rf9_1> (slot=9, port=0) {
        dsu (slot=9, port=0, init_addr=0)
        rep (slot=9, port=0, level=0, iter=64, step=1, delay=0)
        rep (slot=9, port=0, level=1, iter=6, step=0, delay=0)
      }
      rop <write_rf8_2> (slot=8, port=0) {
        dsu (slot=8, port=0, init_addr=0)
        rep (slot=8, port=0, level=0, iter=32, step=1, delay=0)
      }
      ...
      rop <read_rf9_1> (slot=9, port=3) {
        ...
        rep (slot=9, port=3, level=1, iter=6, step=0, delay=60)
      }
    ...
    cell (x=2, y=0) {
      ...
      rop <write_io_2_1> (slot=2, port=2) {
        ...
        rep (slot=2, port=2, level=1, iter=6, step=4, delay=60)
      }
      ...
      rop <output_r_3_1> (slot=1, port=3) {
        ...
        rep (slot=1, port=3, level=0, iter=26, step=1, delay=0)
      }
      rop <output_w_3_1> (slot=1, port=1) {
        dsu (slot=1, port=1, init_addr_sd=1, init_addr=2)
        rep (slot=1, port=1, level=0, iter=26, step=1, delay=0)
      }
    }
  ...
  epoch <cbl0> { # calculation block loop 0
    cell (x=0, y=0) {
      cop <addr_calc0> {
        calc (mode=1, operand1=1, operand2_sd=0, operand2=26, result=1)
      }
    }
    cell (x=2, y=0) {
      cop <addr_calc1> {
