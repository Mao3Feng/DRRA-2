  ...
  epoch <rb0> {
    ...
    cell (x=1, y=0) {
      ...
      rop <write_rf3_1> (slot=3, port=2) {
        ...
        rep (slot=3, port=2, level=1, iter=6, step=0, delay=60)
      }
      ...
      rop <read_rf3_1> (slot=3, port=1) {
        ...
        rep (slot=3, port=1, level=1, iter=6, step=0, delay=0)
      }
      ...
      rop <write_rf4_1> (slot=4, port=0) {
        ...
        rep (slot=4, port=0, level=1, iter=6, step=0, delay=0)
      }
    
      rop <write_rf4_2> (slot=4, port=0) {
        dsu (slot=4, port=0, init_addr=0)
        rep (slot=4, port=0, level=0, iter=32, step=1, delay=0)
      }
      ...
      rop <read_rf4_1> (slot=4, port=3) {
        ...
        rep (slot=4, port=3, level=1, iter=6, step=0, delay=60)
      }
