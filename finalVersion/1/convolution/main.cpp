 ...
 */
void init() {
#define N 11287 * 16 // size of input file
 ...
 */
void model_l0() {
  int a_size = 418; // matrix a: 418*418
  int a_1row_line = (a_size-1)/16 + 1; // 1 row of a uses 27 rows of RF
  int b_size = a_size-2; // filter: 3*3, matrix b: 416*416
  int b_1row_line = (b_size-1)/16 + 1; // 1 row of b uses 26 rows of RF
  int b_line = ((b_size-1)/16 + 1) * b_size; // matrix b uses 11076 rows of RF
  int b_num  = b_line * 16; // matrix b uses 11076*16 data in RF
