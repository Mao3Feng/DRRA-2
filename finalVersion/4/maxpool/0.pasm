...
loop <lb0> (iter=52) { #52
  ...
  epoch <cbl0> { # calculation block loop 0
    cell (x=0, y=0) {
      cop <addr_calc0> {
        calc (mode=1, operand1=1, operand2_sd=0, operand2=52, result=1)
      }
    }
  }
  ...
  epoch <cbl1> {
    cell (x=2, y=0) {
      cop <addr_calc1> {
        calc (mode=1, operand1=2, operand2_sd=0, operand2=14, result=2)
      }
    }
  }
}