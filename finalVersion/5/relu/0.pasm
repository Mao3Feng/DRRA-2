...
loop <lb0> (iter=104) {
  epoch <rb0> {
    ...
    cell (x=1, y=0) {
      ...
      rop <write_rf4_zero> (slot=4, port=2) {
        dsu (slot=4, port=2, init_addr=2)
      }
      ...
      rop <write_rf4_2> (slot=4, port=0) {
        dsu (slot=4, port=0, init_addr=0)
        rep (slot=4, port=0, level=0, iter=40, step=1, delay=0)
      }
      ...
      rop <read_rf4_2> (slot=4, port=3) {
        dsu (slot=4, port=3, init_addr=0)
        rep (slot=4, port=3, level=0, iter=3, step=1, delay=0)
      }
    }
