epoch <config> {
  ...
  cell (x=1, y=0) {
    ...
    rop <route1wr> (slot=0, port=2) {
      route (slot=0, option=0, sr=1, source=1, target=0b1011100000)
...
loop <lb0> (iter=104) { #104
  epoch <rb0> {
    cell (x=0, y=0) {
      #2.2-load input file
      #round1: row0, line0-3 of input matrix
      rop <load_r_2_2> (slot=1, port=0) {
        dsu (slot=1, port=0, init_addr_sd=1, init_addr=1)
        rep (slot=1, port=0, level=0, iter=7, step=1, delay=0)
      }
      rop <load_w_2_2> (slot=1, port=2) {
        dsu (slot=1, port=2, init_addr=0)
        rep (slot=1, port=2, level=0, iter=7, step=1, delay=0)
      }
      #3.2-read IOSRAM
      #round1: row0, line0-3 of input matrix
      ...
      #round2: row0, line4-6 of input matrix
    ...
    cell (x=1, y=0) {
      ...
      rop <write_rf9_zero> (slot=9, port=2) {
        dsu (slot=9, port=2, init_addr=2)
      }
      ...
      rop <read_rf5_2> (slot=5, port=1) {
        dsu (slot=5, port=1, init_addr=0)
        rep (slot=5, port=1, level=0, iter=40, step=0, delay=0)
      }
      rop <read_rf6_2> (slot=6, port=1) {
        dsu (slot=6, port=1, init_addr=0)
        rep (slot=6, port=1, level=0, iter=40, step=1, delay=0)
      }
      ...
      rop <read_rf7_2> (slot=7, port=1) {
        dsu (slot=7, port=1, init_addr=1)
        rep (slot=7, port=1, level=0, iter=40, step=0, delay=0)
      }
      rop <read_rf8_2> (slot=8, port=1) {
        dsu (slot=8, port=1, init_addr=0)
        rep (slot=8, port=1, level=0, iter=40, step=1, delay=0)
      }
      ...
      rop <write_rf8_2> (slot=8, port=0) {
        dsu (slot=8, port=0, init_addr=0)
        rep (slot=8, port=0, level=0, iter=40, step=1, delay=0)
      }
      rop <write_rf9_2> (slot=9, port=0) {
        dsu (slot=9, port=0, init_addr=0)
        rep (slot=9, port=0, level=0, iter=40, step=1, delay=0)
      }
