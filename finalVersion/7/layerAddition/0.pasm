...
epoch <cbi1>{
  cell (x=0, y=0){
    cop <addr_init1>{
      calc (mode=1, operand1=2, operand2_sd=0, operand2=208, result=2)
    }
  }
}
  ...
  epoch <rb1> {
    cell (x=0, y=0) {
      ...
      rop <load_r_2_2> (slot=1, port=0) {
        ...
        rep (slot=1, port=0, level=0, iter=4, step=1, delay=0)
        rep (slot=1, port=0, level=1, iter=63, step=208, delay=49)
      }
      rop <load_w_2_2> (slot=1, port=2) {
        dsu (slot=1, port=2, init_addr=4)
        rep (slot=1, port=2, level=0, iter=4, step=1, delay=0)
        rep (slot=1, port=2, level=1, iter=63, step=0, delay=49)
      }
      ...
      rop <read_io_3_2> (slot=2, port=3) {
        ...
        rep (slot=2, port=3, level=0, iter=4, step=1, delay=0)
        rep (slot=2, port=3, level=1, iter=63, step=0, delay=49)
      }
    }
    ...
    cell (x=1, y=0) {
      ...
      rop <write_rf4> (slot=4, port=2) {
        ...
        rep (slot=4, port=2, level=1, iter=63, step=0, delay=49)
      }
      ...
      rop <read_rf3> (slot=3, port=1) {
        ...
        rep (slot=3, port=1, level=1, iter=63, step=0, delay=1)
      }
  
      rop <read_rf4> (slot=4, port=1) {
        dsu (slot=4, port=1, init_addr=0)
        rep (slot=4, port=1, level=0, iter=52, step=1, delay=0)
        rep (slot=4, port=1, level=1, iter=63, step=0, delay=1)
      }
      ...
      rop <write_rf3_back> (slot=3, port=0) {
        ...
        rep (slot=3, port=0, level=0, iter=52, step=1, delay=0)
        rep (slot=3, port=0, level=1, iter=63, step=0, delay=1)
      }
