epoch <rb0> {
  cell (x=0, y=0) {
    ...
    rop <read_io_3_1> (slot=2, port=3) {
      ...
      rep (slot=2, port=3, level=2, iter=4, step=0, delay=48)
    }
  }
  
  cell (x=1, y=0) {
    #1 - Build route
    # From cell 0_0 to cell 1_0's slot3
    # From cell 1_0's slot4 to cell 2_0
    ...
    rop <write_rf3_1> (slot=3, port=2) {
      ...
      rep (slot=3, port=2, level=1, iter=52, step=0, delay=48)
    }
    ...
    rop <read_rf3_1> (slot=3, port=1) {
      ...
      rep (slot=3, port=1, level=0, iter=52, step=1, delay=0)
    ...
    rop <write_rf4_1> (slot=4, port=0) {
      ...
      rep (slot=4, port=0, level=0, iter=52, step=1, delay=0)
      rep (slot=4, port=0, level=1, iter=52, step=0, delay=0)
    }
    ...
    rop <read_rf4_1> (slot=4, port=3) {
      ...
      rep (slot=4, port=3, level=1, iter=52, step=0, delay=48)
    }
  }
  ...
  cell (x=2, y=0) {
    ...
    rop <write_io_2_1> (slot=2, port=2) {
      ...
      rep (slot=2, port=2, level=2, iter=4, step=0, delay=48)
    }
    ...
    rop <output_r_3_1> (slot=1, port=3) {
      ...
      rep (slot=1, port=3, level=1, iter=4, step=0, delay=t1)
    }
  
    rop <output_w_3_1> (slot=1, port=1) {
      dsu (slot=1, port=1, init_addr=0)
      rep (slot=1, port=1, level=0, iter=52, step=1, delay=0)
      rep (slot=1, port=1, level=1, iter=4, step=52, delay=t1)
    }
  }
}