...
epoch <cbi1> { # 问题1，calc的operand2位宽不够。
  cell (x=0, y=0) {
    cop <addr_init1>{
      calc (mode=1, operand1=2, operand2_sd=0, operand2=2704, result=2)
    }
  }
}
...
loop <lb1> {iter=208} { # 问题2，循环嵌套怎么做？可以展开但仍需解决问题1。
  loop <lb0> (iter=3) {
    epoch <rb0> {
      cell (x=0, y=0) {
        #2.1 - Load input file
        # Round1: layer0 row0 line0-3, 4-7, 8-11 of input matrix
    ...
    epoch <rb1> {
      cell (x=0, y=0) {
        ...
        rop <load_r_2_2> (slot=1, port=0) {
          ...
          rep (slot=1, port=0, level=0, iter=4, step=1, delay=0)
          rep (slot=1, port=0, level=1, iter=15, step=2704, delay=61)
        }
        rop <load_w_2_2> (slot=1, port=2) {
          dsu (slot=1, port=2, init_addr=13)
          rep (slot=1, port=2, level=0, iter=4, step=1, delay=0)
          rep (slot=1, port=2, level=1, iter=15, step=0, delay=61)
        }
        #3.2 - Read IOSRAM
        # Round1: layer1 row0 line0-3, 4-7, 8-11 of input matrix
        rop <read_io_3_2> (slot=2, port=3) {
          ...
          rep (slot=2, port=3, level=0, iter=4, step=1, delay=0)
          rep (slot=2, port=3, level=1, iter=15, step=0, delay=61)
        }
      }
      ...
      cell (x=1, y=0) {
        ...
        rop <write_rf4_1> (slot=4, port=2) {
          ...
          rep (slot=4, port=2, level=1, iter=15, step=0, delay=61)
        }
        ...
        rop <write_rf3_back_1> (slot=3, port=0) {
          ...
          rep (slot=3, port=0, level=1, iter=15, step=0, delay=1)
        }
    ...
    epoch <rb2> { #tail
      cell (x=0, y=0) {
        ...
        rop <load_w_2_3> (slot=1, port=2) {
          dsu (slot=1, port=2, init_addr=12)
        }
    ...
    epoch <rb3> { #tail
      cell (x=0, y=0) {
        ...
        rop <load_r_2_4> (slot=1, port=0) {
          dsu (slot=1, port=0, init_addr=2716)
        }

        rop <load_w_2_4> (slot=1, port=2) {
          dsu (slot=1, port=2, init_addr=25)
        }
      ...
      cell (x=2, y=0) {
        ...
        rop <output_r_3_2> (slot=1, port=3) {
          dsu (slot=1, port=3, init_addr=12)
        }
    ...
    epoch <cbl2> {
      cell (x=2, y=0){
        cop <addr_calc2>{
          calc (mode=1, operand1=3, operand2_sd=0, operand2=13, result=3)
        }
      }
    }
}