  ...
  epoch <rb0> {
    ...
    cell (x=1, y=0) {
      rop <write_rf6_1> (slot=6, port=2) {
        ...
        rep (slot=6, port=2, level=1, iter=3, step=0, delay=60)
      }
      ...
      rop <read_rf5_1> (slot=5, port=1) {
        ...
        rep (slot=5, port=1, level=1, iter=3, step=0, delay=0)
      }
      rop <read_rf6_1> (slot=6, port=1) {
        dsu (slot=6, port=1, init_addr=0)
        rep (slot=6, port=1, level=0, iter=64, step=1, delay=0)
        rep (slot=6, port=1, level=1, iter=3, step=0, delay=0)
      }
      rop <read_rf5_2> (slot=5, port=1) {
        dsu (slot=5, port=1, init_addr=0)
        rep (slot=5, port=1, level=0, iter=16, step=0, delay=0)
      }
      ...
      rop <read_rf7_1> (slot=7, port=1) {
        ...
        rep (slot=7, port=1, level=1, iter=3, step=0, delay=0)
      }
      rop <read_rf8_1> (slot=8, port=1) {
        dsu (slot=8, port=1, init_addr=0)
        rep (slot=8, port=1, level=0, iter=64, step=1, delay=0)
        rep (slot=8, port=1, level=1, iter=3, step=0, delay=0)
      }
      rop <read_rf7_2> (slot=7, port=1) {
        dsu (slot=7, port=1, init_addr=1)
        rep (slot=7, port=1, level=0, iter=16, step=0, delay=0)
      }
      rop <read_rf8_2> (slot=8, port=1) {
        dsu (slot=8, port=1, init_addr=0)
        rep (slot=8, port=1, level=0, iter=16, step=1, delay=0)
      }
      ...
      rop <write_rf8_1> (slot=8, port=0) {
        ...
        rep (slot=8, port=0, level=1, iter=3, step=0, delay=0)
      }
      rop <write_rf9_1> (slot=9, port=0) {
        dsu (slot=9, port=0, init_addr=0)
        rep (slot=9, port=0, level=0, iter=64, step=1, delay=0)
        rep (slot=9, port=0, level=1, iter=3, step=0, delay=0)
      }
      rop <write_rf8_2> (slot=8, port=0) {
        dsu (slot=8, port=0, init_addr=0)
        rep (slot=8, port=0, level=0, iter=16, step=1, delay=0)
      }
      rop <write_rf9_2> (slot=9, port=0) {
        dsu (slot=9, port=0, init_addr=0)
        rep (slot=9, port=0, level=0, iter=16, step=1, delay=0)
      }
      ...
      rop <read_rf9_1> (slot=9, port=3) {
        ...
        rep (slot=9, port=3, level=1, iter=3, step=0, delay=60)
      }
