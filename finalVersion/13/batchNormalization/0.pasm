...
epoch <rb0> {
  ...
  cell (x=1, y=0) {
    ...
    rop <write_rf6_1> (slot=6, port=2) {
      ...
      rep (slot=6, port=2, level=1, iter=3, step=0, delay=t0)
    }
    ...
    rop <read_rf5_1> (slot=5, port=1) {
      ...
      rep (slot=5, port=1, level=0, iter=13, step=0, delay=0)
    ...
    rop <read_rf6_1> (slot=6, port=1) {
      ...
      rep (slot=6, port=1, level=0, iter=13, step=1, delay=0)
    ...
    rop <read_rf7_1> (slot=7, port=1) {
      ...
      rep (slot=7, port=1, level=0, iter=13, step=0, delay=0)
    ...
    rop <read_rf8_1> (slot=8, port=1) {
      ...
      rep (slot=8, port=1, level=0, iter=13, step=1, delay=0)
      rep (slot=8, port=1, level=1, iter=4, step=16, delay=0)
    ...
    rop <write_rf8_1> (slot=8, port=0) {
      ...
      rep (slot=8, port=0, level=0, iter=13, step=1, delay=0)
      rep (slot=8, port=0, level=1, iter=4, step=16, delay=0)
      rep (slot=8, port=0, level=2, iter=3, step=0, delay=0)
    }
    rop <write_rf9_1> (slot=9, port=0) {
      dsu (slot=9, port=0, init_addr=0)
      rep (slot=9, port=0, level=0, iter=13, step=1, delay=0)
      rep (slot=9, port=0, level=1, iter=4, step=16, delay=0)
    ...
    rop <read_rf9_1> (slot=9, port=3) {
      ...
      rep (slot=9, port=3, level=1, iter=3, step=0, delay=t1)
    }
  ...
  cell (x=2, y=0) {
    ...
    rop <write_io_2_1> (slot=2, port=2) {
      ...
      rep (slot=2, port=2, level=1, iter=3, step=4, delay=t1)
    }
