...
rep slot=2, port=3, level=1, iter=12, step=1, delay=t0
...
rep slot=3, port=1, level=2, iter=12, step=0, delay=2
...
rep slot=4, port=1, level=2, iter=12, step=0, delay=2

operation dpu slot=1, port=0
dpu slot=1, option=0, mode=16
rep slot=1, port=0, level=0, iter=144, step=0, delay=3
...
rep slot=5, port=0, level=1, iter=12, step=0, delay=3

#6.1-read result from RF5
#round1: row0-12
operation read_rf5 slot=5, port=3
dsu slot=5, port=3, init_addr=0
rep slot=5, port=3, level=0, iter=12, step=0, delay=t2
...
#round1: store row0-11
operation write_io_2_1 slot=2, port=2
dsu slot=2, port=2, init_addr=0
rep slot=2, port=2, level=0, iter=12, step=1, delay=t2

#3.1-store result to output file
#round1: store row0-11 (actually store 13 lines due to data format)
