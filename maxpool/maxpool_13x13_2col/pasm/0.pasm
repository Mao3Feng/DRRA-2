...
rep slot=3, port=2, level=0, iter=6, step=0, delay=t1
...
rep slot=1, port=0, level=0, iter=72, step=0, delay=3
...
#round1: store row0-5 (actually store 13 lines due to data format)
...
#2.1-load input file
#round1: row6-12 of input matrix
...
#3.1-store result to output file
#round1: store row6-11 (actually store 13 lines due to data format)
