...
#2.1-load input file
#round1,2: row0-11, 12-25 of input matrix
...
rep slot=0, port=0, level=1, iter=13, step=0, delay=1
...
rep slot=3, port=1, level=2, iter=13, step=0, delay=2
...
rep slot=4, port=1, level=2, iter=13, step=0, delay=2

operation dpu slot=1, port=0
dpu slot=1, option=0, mode=16
rep slot=1, port=0, level=0, iter=338, step=0, delay=3
...
rep slot=5, port=0, level=1, iter=13, step=0, delay=3
...
rep slot=5, port=3, level=1, iter=13, step=0, delay=t3
...
#2.1-load input file
#round3,4: row26-37, 38-51 of input matrix
