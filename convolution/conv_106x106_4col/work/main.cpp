 ...
 */
void init() {
#define N 743 * 16 // size of input file
...
void model_l0() {
  ...
  for (int i = 0; i < b_size; i++) { // index of row, row0,1,2, row1,2,3, ... row61,62,63 of a
    for (int j =0; j < b_size; j++) { // index of column, b[0], b[1], ... b[61]
